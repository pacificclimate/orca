...
def reconstruct_dataset_test(temp_files, url):
    with NamedTemporaryFile(suffix=".nc", dir="/tmp") as outfile:
        data_path = reconstruct_dataset(temp_files, outfile.name)
...
def test_reconstruct_dataset_online(temp_files, source_url):
    reconstruct_dataset_test(temp_files, source_url)
...
def test_reconstruct_dataset_local(temp_files, full_file):
    reconstruct_dataset_test(temp_files, full_file)
